...
- Base Sepolia (84532) full 24-contract deployment addresses in `docs/contracts/index.md` — Core, Token, Governance, NIST, Account Abstraction, Agent, Bridge, Robotics, plus 4 first-ever deployments (TAGITEmissions, TAGITBurner, TAGITVesting, IntegrationFactory).
