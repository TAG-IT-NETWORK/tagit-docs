...
- `docs/guides/agent-integration-tutorial.md` — External agent integration tutorial: NFC scan → SUN verification → on-chain lookup → escrow settlement → A2A cross-verification. PRD-017. Covers task [3314e3e9].
...
- `CHANGELOG.md` — Added versioning section for PRD-017 developer docs.
